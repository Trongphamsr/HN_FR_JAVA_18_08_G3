...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="<%=request.getContextPath() %>/metisMenu.min.css" rel="stylesheet">
                        ...
                        <form id="loginform" class="form-horizontal" role="form">
                            ...
                            <div class="input-group">
                                      <div class="checkbox">
                                        ...
                                        <label>
                                            <input onchange="document.getElementById('login-password').type = this.checked ? 'text' : 'password'" name="show_password" id="show_passowrd" class="" type="checkbox"/>show Me
                                        </label>
                                      </div>
                                    </div>
