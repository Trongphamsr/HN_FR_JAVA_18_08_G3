                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3><marquee width="60%" behavior="alternate" bgcolor="pink">Select All Product From Table Product</marquee></h3>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                   ...
                                   <tr class="even gradeA">
                                        ...
                                        <td class="center td_all">
                                              <a onclick="return confirm('Are you sure you want to delete this item?');" class="alert alert-danger" href="#">delete</a>
                                    ...
                                    <tr class="even gradeA">
                                        ...
                                        <td class="center td_all">
                                              <a onclick="return confirm('Are you sure you want to delete this item?');" class="alert alert-danger" href="#">delete</a>
                                              <a class="alert alert-success" href="#">edit</a>
                                        </td>
                                    </tr> 
